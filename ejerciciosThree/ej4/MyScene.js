...
import { TrebolBarrido } from './TrebolBarrido.js'
...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    this.model = new MyCorazon();
    this.model1 = new MyTrebol();
    this.model2 = new Pica();
    this.model3 = new Rombo();
    this.model4 = new TrebolBarrido();
    this.model5 = new CorazonBarrido();
