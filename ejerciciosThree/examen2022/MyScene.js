...
class MyScene extends THREE.Scene {
	constructor(myCanvas) {
		...
		this.nave = new MyNave(this.gui);
		this.sceneObj.push(this.nave);
	...
	update() {
		...
		for (var i = 0; i < this.sceneAxis.length; i++)
			this.sceneAxis[i].visible = this.guiControls.axisOnOff;
